...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: MapPin, label: t('contact.info.visit.label'), value: t('contact.info.visit.value') },
    { icon: Phone, label: t('contact.info.call.label'), value: t('contact.info.call.value') },
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="scroll-reveal" style={{ transitionDelay: '0.2s' }}>
            <div className="poster-block bg-white">
              <h3 className="font-display text-2xl text-[#1D3557] mb-8 uppercase">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full ticket-btn flex items-center justify-center gap-2 disabled:opacity-70 uppercase"
                >
                  {isSubmitting ? (
                    t('contact.form.btn_submitting')
                  ) : (
                    <>
          ...
          <div className="scroll-reveal space-y-8" style={{ transitionDelay: '0.3s' }}>
            ...
            <div className="bg-[#E63946] p-8 text-white">
              <h3 className="font-display text-2xl mb-2 uppercase">{t('contact.cta.title')}</h3>
