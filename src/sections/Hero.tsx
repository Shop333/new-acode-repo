        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div ref={textRef} className="relative z-10 order-2 lg:order-1">
            ...
            <div className="scroll-reveal mb-6">
              <span className="inline-flex items-center gap-3 geo-block-blue text-sm tracking-widest uppercase">
            ...
            <div className="scroll-reveal mt-16 grid grid-cols-3 gap-8 max-w-md" style={{ transitionDelay: '0.4s' }}>
              <div className="text-center">
                ...
                <div className="font-body text-xs tracking-wider text-[#1D3557]/70 uppercase mt-1">{t('hero.stats.exp')}</div>
              </div>
              <div className="text-center">
                <div className="font-display text-4xl text-[#E63946]">5K+</div>
                <div className="font-body text-xs tracking-wider text-[#1D3557]/70 uppercase mt-1">{t('hero.stats.clients')}</div>
              </div>
              <div className="text-center">
                <div className="font-display text-4xl text-[#E63946]">4.9</div>
                <div className="font-body text-xs tracking-wider text-[#1D3557]/70 uppercase mt-1">{t('hero.stats.rating')}</div>
              </div>
            </div>
          </div>
