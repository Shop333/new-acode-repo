...
const Barbers = () => {
  ...
  // Data barbers dipindahkan ke dalam komponen agar bisa menggunakan t()
  const barbers: Barber[] = [
    {
      id: 1,
      name: t('barbers.list.barber1.name'),
      specialty: t('barbers.list.barber1.specialty'),
      experience: t('barbers.list.barber1.experience'),
      image: '/barber1.jpg',
      bio: t('barbers.list.barber1.bio')
    },
    {
      id: 2,
      name: t('barbers.list.barber2.name'),
      specialty: t('barbers.list.barber2.specialty'),
      experience: t('barbers.list.barber2.experience'),
      image: '/barber2.jpg',
      bio: t('barbers.list.barber2.bio')
    },
    {
      id: 3,
      name: t('barbers.list.barber3.name'),
      specialty: t('barbers.list.barber3.specialty'),
      experience: t('barbers.list.barber3.experience'),
      image: '/barber3.jpg',
      bio: t('barbers.list.barber3.bio')
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          <div className="scroll-reveal" style={{ transitionDelay: '0.1s' }}>
            <h2 className="font-display text-4xl lg:text-6xl text-[#1D3557] mb-4 uppercase">
              {t('barbers.heading')}
            </h2>
          ...
          {barbers.map((barber, index) => (
            ...
            >
              ...
              <div className="relative mb-6">
                ...
                {/* Experience badge */}
                <div className="absolute -bottom-4 right-4 bg-[#E63946] text-white px-4 py-2 font-display text-sm whitespace-nowrap">
                  {barber.experience}
                </div>

                {/* Specialty tag */}
                <div className="absolute top-4 left-4 bg-[#1D3557] text-white px-3 py-1.5 font-body text-xs tracking-wider uppercase">
                  {barber.specialty}
                </div>
              </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              <h3 className="font-display text-2xl text-white mb-2 uppercase">
                {t('barbers.join.title')}
              </h3>
              <p className="font-body text-white/70">
                {t('barbers.join.subtitle')}
              </p>
            </div>
            <button className="ticket-btn bg-white text-[#1D3557] hover:bg-[#E63946] hover:text-white whitespace-nowrap uppercase">
              {t('barbers.join.btn')}
            </button>
          </div>
        </div>
